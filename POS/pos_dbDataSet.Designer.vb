...
Partial Public Class pos_dbDataSet
    ...
    Partial Public Class ProductDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddProductRow(ByVal ProductCode As String, ByVal ProductName As String, ByVal ProductImage() As Byte, ByVal Barcode As String, ByVal CategoryName As String, ByVal BrandName As String, ByVal SupplierName As String, ByVal OriginalPrice As Decimal, ByVal DiscountedPerc As Decimal, ByVal DiscountedDateFrom As Date, ByVal DiscountedDateTo As Date, ByVal DiscountedPrice As Decimal, ByVal FinalPrice As Decimal, ByVal Quantity As Integer, ByVal IsInstock As Boolean) As ProductRow
            Dim rowProductRow As ProductRow = CType(Me.NewRow,ProductRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ProductCode, ProductName, ProductImage, Barcode, CategoryName, BrandName, SupplierName, OriginalPrice, DiscountedPerc, DiscountedDateFrom, DiscountedDateTo, DiscountedPrice, FinalPrice, Quantity, IsInstock}
    ...
    Partial Public Class StoreDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddStoreRow(ByVal StoreName As String, ByVal Slogan As String, ByVal Logo() As Byte, ByVal ThemeColor As String, ByVal TinNo As String, ByVal ContactNo As String, ByVal IsActive As Boolean) As StoreRow
            Dim rowStoreRow As StoreRow = CType(Me.NewRow,StoreRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, StoreName, Slogan, Logo, ThemeColor, TinNo, ContactNo, IsActive}
    ...
    Partial Public Class TransactionDetailsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddTransactionDetailsRow(ByVal TransactionHeaderId As Integer, ByVal ProductCode As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal BrandName As String, ByVal SupplierName As String, ByVal Barcode As String, ByVal OriginalPrice As Decimal, ByVal DiscountedPerc As Decimal, ByVal DiscountedPrice As Decimal, ByVal FinalPrice As Decimal, ByVal Quantity As Integer, ByVal TotalAmount As Decimal) As TransactionDetailsRow
            Dim rowTransactionDetailsRow As TransactionDetailsRow = CType(Me.NewRow,TransactionDetailsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, TransactionHeaderId, ProductCode, ProductName, CategoryName, BrandName, SupplierName, Barcode, OriginalPrice, DiscountedPerc, DiscountedPrice, FinalPrice, Quantity, TotalAmount}
    ...
    Partial Public Class TransactionHeaderDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddTransactionHeaderRow(ByVal PersonnelId As Integer, ByVal InvoiceNo As String, ByVal GrandTotal As Decimal, ByVal PaymentAmount As Decimal, ByVal PaymentChange As Decimal, ByVal PaymentStatus As String) As TransactionHeaderRow
            Dim rowTransactionHeaderRow As TransactionHeaderRow = CType(Me.NewRow,TransactionHeaderRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, PersonnelId, InvoiceNo, GrandTotal, PaymentAmount, PaymentChange, PaymentStatus}
...
Namespace pos_dbDataSetTableAdapters
    ...
    Partial Public Class CategoryTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Category] ([CategoryName]) VALUES (@CategoryName)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT Id, CategoryName FROM dbo.Category"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class ProductTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([ProductCode], [ProductName], [ProductImage], [Barco"& _ 
                "de], [CategoryName], [BrandName], [SupplierName], [OriginalPrice], [DiscountedPe"& _ 
                "rc], [DiscountedDateFrom], [DiscountedDateTo], [DiscountedPrice], [FinalPrice], "& _ 
                "[Quantity], [IsInstock]) VALUES (@ProductCode, @ProductName, @ProductImage, @Bar"& _ 
                "code, @CategoryName, @BrandName, @SupplierName, @OriginalPrice, @DiscountedPerc,"& _ 
                " @DiscountedDateFrom, @DiscountedDateTo, @DiscountedPrice, @FinalPrice, @Quantit"& _ 
                "y, @IsInstock)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, ProductCode, ProductName, ProductImage, Barcode, CategoryName, BrandNa"& _ 
                ...
                "ateTo, DiscountedPrice, FinalPrice, Quantity, IsInstock FROM dbo.Product"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal ProductCode As String, ByVal ProductName As String, ByVal ProductImage() As Byte, ByVal Barcode As String, ByVal CategoryName As String, ByVal BrandName As String, ByVal SupplierName As String, ByVal OriginalPrice As Global.System.Nullable(Of Decimal), ByVal DiscountedPerc As Global.System.Nullable(Of Decimal), ByVal DiscountedDateFrom As Global.System.Nullable(Of Date), ByVal DiscountedDateTo As Global.System.Nullable(Of Date), ByVal DiscountedPrice As Global.System.Nullable(Of Decimal), ByVal FinalPrice As Global.System.Nullable(Of Decimal), ByVal Quantity As Global.System.Nullable(Of Integer), ByVal IsInstock As Global.System.Nullable(Of Boolean)) As Integer
    ...
    Partial Public Class StoreTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Store] ([StoreName], [Slogan], [Logo], [ThemeColor], [TinNo], "& _ 
                "[ContactNo], [IsActive]) VALUES (@StoreName, @Slogan, @Logo, @ThemeColor, @TinNo"& _ 
                ", @ContactNo, @IsActive)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT Id, StoreName, Slogan, Logo, ThemeColor, TinNo, ContactNo, IsActive FROM d"& _ 
                "bo.Store"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal StoreName As String, ByVal Slogan As String, ByVal Logo() As Byte, ByVal ThemeColor As String, ByVal TinNo As String, ByVal ContactNo As String, ByVal IsActive As Global.System.Nullable(Of Boolean)) As Integer
    ...
    Partial Public Class TransactionDetailsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TransactionDetails] ([TransactionHeaderId], [ProductCode], [Pr"& _ 
                "oductName], [CategoryName], [BrandName], [SupplierName], [Barcode], [OriginalPri"& _ 
                "ce], [DiscountedPerc], [DiscountedPrice], [FinalPrice], [Quantity], [TotalAmount"& _ 
                "]) VALUES (@TransactionHeaderId, @ProductCode, @ProductName, @CategoryName, @Bra"& _ 
                "ndName, @SupplierName, @Barcode, @OriginalPrice, @DiscountedPerc, @DiscountedPri"& _ 
                "ce, @FinalPrice, @Quantity, @TotalAmount)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, TransactionHeaderId, ProductCode, ProductName, CategoryName, BrandName"& _ 
                ...
                "ice, Quantity, TotalAmount FROM dbo.TransactionDetails"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal TransactionHeaderId As Integer, ByVal ProductCode As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal BrandName As String, ByVal SupplierName As String, ByVal Barcode As String, ByVal OriginalPrice As Global.System.Nullable(Of Decimal), ByVal DiscountedPerc As Global.System.Nullable(Of Decimal), ByVal DiscountedPrice As Global.System.Nullable(Of Decimal), ByVal FinalPrice As Global.System.Nullable(Of Decimal), ByVal Quantity As Global.System.Nullable(Of Integer), ByVal TotalAmount As Global.System.Nullable(Of Decimal)) As Integer
    ...
    Partial Public Class TransactionHeaderTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TransactionHeader] ([PersonnelId], [InvoiceNo], [GrandTotal], "& _ 
                "[PaymentAmount], [PaymentChange], [PaymentStatus]) VALUES (@PersonnelId, @Invoic"& _ 
                "eNo, @GrandTotal, @PaymentAmount, @PaymentChange, @PaymentStatus)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, PersonnelId, InvoiceNo, GrandTotal, PaymentAmount, PaymentChange, Paym"& _ 
                "entStatus FROM dbo.TransactionHeader"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal PersonnelId As Integer, ByVal InvoiceNo As String, ByVal GrandTotal As Global.System.Nullable(Of Decimal), ByVal PaymentAmount As Global.System.Nullable(Of Decimal), ByVal PaymentChange As Global.System.Nullable(Of Decimal), ByVal PaymentStatus As String) As Integer
