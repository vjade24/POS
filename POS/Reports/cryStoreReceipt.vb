...
Public Class cryStoreReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS.cryStoreReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryStoreReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryStoreReceipt = New cryStoreReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
