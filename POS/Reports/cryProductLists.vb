...
Public Class cryProductLists
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS.cryProductLists.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryProductLists
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryProductLists = New cryProductLists()
        rpt.Site = Me.Site
        Return rpt
    End Function
