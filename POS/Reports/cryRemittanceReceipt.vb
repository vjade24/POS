...
Public Class cryRemittanceReceipt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryRemittanceReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS.cryRemittanceReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryRemittanceReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryRemittanceReceipt = New cryRemittanceReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
